...
#
# Created: Wed Jan 30 10:24:08 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_loadStimulus_2 = QtGui.QPushButton(self.groupBox_bgStimulus_2)
        self.pushButton_loadStimulus_2.setGeometry(QtCore.QRect(240, 0, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.pushButton_loadStimulus_2.setFont(font)
        self.pushButton_loadStimulus_2.setText(QtGui.QApplication.translate("MainWindow", "Load Experiment", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_loadStimulus_2.setObjectName(_fromUtf8("pushButton_loadStimulus_2"))
        ...
        self.tableWidget_bgStimulus_2 = QtGui.QTableWidget(self.groupBox_5)
        self.tableWidget_bgStimulus_2.setGeometry(QtCore.QRect(10, 20, 371, 161))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.tableWidget_bgStimulus_2.setFont(font)
        self.tableWidget_bgStimulus_2.setRowCount(10)
        self.tableWidget_bgStimulus_2.setColumnCount(2)
        self.tableWidget_bgStimulus_2.setObjectName(_fromUtf8("tableWidget_bgStimulus_2"))
        self.tableWidget_bgStimulus_2.horizontalHeader().setDefaultSectionSize(150)
